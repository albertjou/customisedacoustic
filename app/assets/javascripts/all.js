/*1384312008,172015917,JIT Construction: v1006116,en_US*/
/**
...
try {
    window.FB || (function (window) {
        ...
        __d("ApiClientConfig", [], {
            "FlashRequest": {
                "swfUrl": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/yB\/r\/YV5wijq5fkW.swf"
            }
        });
            ...
            var g = b('sdk.Canvas.Environment'),
                ...
                p = n.extend({
                    ...
                    trackEvents: function (r) {
                        ...
                        for (var s in r)
                            if (r.hasOwnProperty(s)) this.trackEvent(s, r[s]);
                        return this;
                    }
                }, l),
                q = {
                    ...
                    _setDialogSizes: function () {
                        ...
                        for (var r in q._dialogs)
                            if (q._dialogs.hasOwnProperty(r)) {
                    ...
                    _handleOrientationChange: function (r) {
                        ...
                        if (o.ipad()) {
                            ...
                            for (var t in q._dialogs)
                                if (q._dialogs.hasOwnProperty(t)) {
                    ...
                    create: function (r) {
                        ...
                        } else u += o.mobile() ? ' fb_dialog_mobile' : ' fb_dialog_advanced'; if (r.content) h.append(r.content, t);
                        s.className = u;
                    ...
                    show: function (r) {
                        ...
                        if (s) {
                            ...
                            q._makeActive(s);
                            q._stack.push(s);
                            if ('fbCallID' in r) q.get(r.fbCallID).inform('iframe_show').trackEvent('show');
                        }
                    },
                    hide: function (r) {
                        var s = q._findRoot(r);
                        ...
                        if (s == q._active) {
                            ...
                            q._restoreBodyPosition();
                            q._hideIPadOverlay();
                            if ('fbCallID' in r) q.get(r.fbCallID).inform('iframe_hide').trackEvent('hide');
                        }
                    },
                    remove: function (r) {
                        r = q._findRoot(r);
                ...
                ba = {
                    ...
                    checkOauthDisplay: function (ea) {
                        ...
                        for (var ha = 0; ha < ga.length; ha++)
                            if (!x.initSitevars.iframePermissions[ES5(ga[ha], 'trim', true)]) return 'popup';
                        return ea.display;
                    },
                    ...
                    getDisplayMode: function (ea, fa) {
                        ...
                        if (!w.getAccessToken() && fa.display == 'dialog' && !ea.loggedOutIframe) {
        ...
        __d("sdk.ui", ["Assert", "copyProperties", "sdk.feature", "sdk.Impressions", "Log", "sdk.UIServer"], function (a, b, c, d, e, f) {
            var g = b('Assert'),
                h = b('copyProperties'),
                i = b('sdk.feature'),
                j = b('sdk.Impressions'),
            ...
            function u(y) {
                ...
                ES5(z, 'forEach', true, function (aa) {
                    ...
                    if (n) {
                        ...
                        n(ea);
                        setTimeout(da, 200);
                    } else da(); if (Math.random() <= 1 / 1000) g(j.getClientID() + '/occludespopups', 'post', {});
                });
            }
        ...
        __d("mergeArrays", [], function (a, b, c, d, e, f) {
            function g(h, i) {
                for (var j = 0; j < i.length; j++)
                    if (ES5(h, 'indexOf', true, i[j]) < 0) h.push(i[j]);
                return h;
            }
            e.exports = g;
        });
                ...
                o = j.extend({
                    ...
                    parse: function (p) {
                        ...
                        for (var s = 1; s < p.length; s++)
                            if (i.instanceOf(o, p[s])) p[s].hasDependency(true);
                        return this;
                    },
                    toFql: function () {
            ...
            var g = b('sdk.api'),
                ...
                m = {
                    ...
                    _process: function (n) {
                        ...
                        for (var t in o)
                            if (o.hasOwnProperty(t)) s.q[t] = o[t].toFql();
        ...
        __d("sdk.init", ["sdk.Cookie", "copyProperties", "createArrayFrom", "sdk.ErrorHandling", "sdk.Event", "Log", "QueryString", "sdk.Runtime"], function (a, b, c, d, e, f) {
            var g = b('sdk.Cookie'),
                h = b('copyProperties'),
                i = b('createArrayFrom'),
        ...
        __d("XFBML", ["Assert", "copyProperties", "createArrayFrom", "sdk.DOM", "sdk.feature", "sdk.Impressions", "Log", "ObservableMixin", "runOnce", "UserAgent"], function (a, b, c, d, e, f) {
            var g = b('Assert'),
                h = b('copyProperties'),
                i = b('createArrayFrom'),
                j = b('sdk.DOM'),
            ...
            function x(ca) {
                var da = ES5(ES5(u(ca, 'className'), 'trim', true).split(/\s+/), 'filter', true, function (ea) {
        ...
        __d("PluginPipe", ["sdk.Content", "copyProperties", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "sdk.Runtime", "UrlMap", "UserAgent", "XFBML", "PluginPipeConfig"], function (a, b, c, d, e, f) {
            var g = b('sdk.Content'),
                h = b('copyProperties'),
                i = b('sdk.feature'),
                j = b('guid'),
                ...
                o = k.extend({
                    process: function () {
                        ...
                        if (this._firstnameonly) {
                            ...
                            p.push('last_name');
                        } else p.push('name'); if (this._subjectId) {
                            p.push('sex');
